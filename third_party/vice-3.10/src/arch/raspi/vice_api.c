...
// Atari800 SIO drive helpers (common/menu.c file flows). VICE machines
// never trigger these (atari-only menu IDs); safe no-op stubs so VICE
// kernels link. The real implementations live in atari800_bridge.cpp.
